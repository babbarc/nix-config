#!/usr/bin/env python3
#
# Vendored VERBATIM from Hermes core (MIT, author "Hermes Agent"):
# skills/web/blocked-page-recovery/scripts/recover_page.py. Kept byte-identical
# to upstream on purpose so `diff` against a fresh Hermes install stays clean
# and re-syncs are trivial - do not edit the logic here. The AXI value-add
# (content-first view, ALL_ROUTES_FAILED route trace, snapshot-age disclosure)
# lives in the thin `recover-page` wrapper, not in this file.
